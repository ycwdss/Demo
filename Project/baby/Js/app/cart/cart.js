   ...
   $(document).ready(function () {
         ...
         $('.operate_del').click(function () {
            ...
            if(offbtn && len==1){
               ...
               $('.cart_bottom').find('.check').removeClass('checked main_bg main_border');
            }
            getTotal();
            return false;
         ...
         $('.cart_list .check ').click(function () {
            ...
            if($chklenght==$listlenght){
               ...
               $('.cart_bottom').find('.check').addClass('checked main_bg main_border');
            }else {
               $('.cart_title').find('.check').removeClass('checked main_bg main_border');
               $('.cart_bottom').find('.check').removeClass('checked main_bg main_border');
            }
         ...
         //全选
         $('.cart_title .check,.cart_bottom .check').click(function () {
            var $this=$(this);
            if($this.hasClass('checked')){
               $('.cart_title .check,.cart_bottom .check').removeClass('checked main_bg main_border')
               $('.cart_list').find('.check').removeClass('checked main_bg main_border');
            }else {
               $('.cart_title .check,.cart_bottom .check').addClass('checked main_bg main_border')

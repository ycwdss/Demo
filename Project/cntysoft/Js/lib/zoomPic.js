...
ZoomPic.prototype = 
{
	initialize : function (id)
	{
		...
		this.options = [
			...
			{width:292, height:220, top:128, left:-71, zIndex:1},
			{width:507, height:380, top:47, left:31, zIndex:2},
			{width:640, height:480, top:0, left:162, zIndex:3},
			{width:507, height:380, top:47, left:427, zIndex:2},
			{width:292, height:220, top:128, left:744, zIndex:1},
		];
	...
	setUp : function ()
	{
		...
		for (i = 0; i < this.aSort.length; i++)
		{
			...
			{
				this.css(this.aSort[i].getElementsByTagName("img")[0], "opacity", 70);
				...
				{
					_this.doMove(this.getElementsByTagName("img")[0], {opacity:70})  ;
				};
	...
	{
        console.log(oElement.addEventListener);
	...
	{
		var _this = this;
		if(oElement && oElement.hasOwnProperty('timer')){

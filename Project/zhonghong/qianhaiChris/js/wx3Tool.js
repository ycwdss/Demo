(function(window, undefined) {
	...
	Wx3Tool.prototype = {
		...
		shareWechatModel : function () {
			wx.hideMenuItems({
	            menuList: ['menuItem:openWithQQBrowser', 'menuItem:openWithSafari', 'menuItem:copyUrl', 'menuItem:share:qq', 'menuItem:share:email', 'menuItem:favorite' ] // 要隐藏的菜单项，只能隐藏“传播类”和“保护类”按钮，所有menu项见附录3
	        });
		},
		//分享到朋友圈。
